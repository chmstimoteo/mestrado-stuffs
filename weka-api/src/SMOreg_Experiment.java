...
public class SMOreg_Experiment {
...
//					new String("-help")
					...
					new String("2"),
					new String("-I"),
					new String("weka.classifiers.functions.supportVector.RegSMOImproved -L 0.001 -W 1 -P 1.0E-12 -T 0.001 -V"),
					new String("-K"), 
					new String("weka.classifiers.functions.supportVector.RBFKernel -C 25007 -G 0.01")
				};
			smo.setOptions(opts);
			SMOreg.runClassifier(smo, opts);
			...
			while (it.hasNext()) {
				...
				double calculated = smo.classifyInstance(instance);
